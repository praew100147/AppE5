import{d as x,am as N,a as _,m as p,f as i,i as y,j as C,k as m,t as f,p as h,h as w,Y as S,o as l,v as $}from"./BZflAdyk.js";import{_ as O}from"./C_QixTwI.js";import"./BFisL5PK.js";const R=/(^|@)\S+:\d+/,k=/^\s*at .*(\S+:\d+|\(native\))/m,F=/^(eval@)?(\[native code\])?$/;function I(t,c){if(typeof t.stacktrace<"u"||typeof t["opera#sourceloc"]<"u")return P(t);if(t.stack&&t.stack.match(k))return b(t);if(t.stack)return T(t);throw new Error("Cannot parse given Error object")}function v(t){if(!t.includes(":"))return[t,void 0,void 0];const r=/(.+?)(?::(\d+))?(?::(\d+))?$/.exec(t.replace(/[()]/g,""));return[r[1],r[2]||void 0,r[3]||void 0]}function d(t,c){return t}function b(t,c){return A(t.stack)}function A(t,c){return d(t.split(`
